	...
	<div class=paysafecashh-content">
		<div class="row">
			<div class="col-md-8">
				...
				Offering Paysafecash payments pays off:<li>Opens up access to untouched customer groups</li><li>Incremental revenue with cash paying customers</li><li>100% payment guarantee, no risk of chargeback</li><li>Guarantees a secure and customer-friendly payment process</li><li>No cannibalization effect of existing payment methods</li>
